    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            loadFeed(0, function () {
                ...
                prevFeedData = $('.feed').text();
                loadFeed(1, function () {
                    // This will get combined text contents from feed at index 1.
                    currentFeedData = $('.feed').text();
                    done();
                });                
            });            
        });

        it('Second feed content should change after loading.', function () {
            expect(prevFeedData).not.toEqual(currentFeedData);
        });
    });
